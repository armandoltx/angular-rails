...
var DocumentsComponent = (function () {
    ...
    DocumentsComponent.prototype.getDocuments = function () {
        ...
        this.documentService.getDocuments() // calling the function getDocuments from the document.service.ts
            .subscribe(function (documents) { return _this.documents = documents; }, //this.documents comes from documents in the export class DocumentsComponent
        function (//this.documents comes from documents in the export class DocumentsComponent
